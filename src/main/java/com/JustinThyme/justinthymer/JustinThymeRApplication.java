...
public class JustinThymeRApplication {
	...
	public CommandLineRunner trial(SeedDao seedDao) {
		return (args) -> {
			...
			//TODO make following conditional work
//			List<Seed> seedsPopulated = seedDao.findAll();
//
//			System.out.println(seedsPopulated);
//			//System.out.println("*****" + toString(length(seedsPopulated)));
//			if (length(seedsPopulated) != 0) {
//
//			} else {
			//note uncomment starts HERE
